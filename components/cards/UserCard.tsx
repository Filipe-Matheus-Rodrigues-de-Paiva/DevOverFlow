...
export default async function UserCard({ user }: UserCardProps) {
  ...
  return (
    <div className="card-wrapper flex w-full flex-col items-center justify-center gap-3 rounded-[10px] p-9 sm:px-11 lg:w-[350px]">
      <Image
        src={user.picture}
        alt=""
        height={100}
      ...
      >
        <h3 className="h3-bold text-dark200_light900 line-clamp-1 text-center dark:text-light-900">
